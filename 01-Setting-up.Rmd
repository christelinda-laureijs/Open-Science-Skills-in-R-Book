...
## Discussion and Activity about Tidy Projects
...
```{r download-workshop-one-pdf, echo=F}
xfun::embed_file('workshop-materials/workshop-1-Rmarkdown worksheet')
```
...
### Activity about Using the R package stylr to tidy your code
...
[Use the space below to document all the changes you made to the data file. This can be a bullet-point list, description, chunks of annotated R code, or a mixture of all three.]{.underline}
