...
Today's workshop is going to be a mix of lecture and activities. You have already downloaded the slides for the lecture, and after I introduce the concept of "tidy projects" we will start working on some activities. These will be outlined on both the slides and within an Rmarkdown document, which we will set-up together, and you can use to make notes if you wish.
